...
SEQUENZA_NOTTURNA_WEEKEND = ["S1n", "S2n"]  # Ven-Sab alternati - CORRETTO: S1n primo
...
def genera_calendario_automatico():
    ...
    idx_notturno_weekend = 0  # CORRETTO: Inizia con S1n (dato di partenza: notte ven-sab = S1n)
...
def crea_tastiera_fisica(user_id):
    ...
    tastiera = [
        ...
        [KeyboardButton("👥 Squadre"), KeyboardButton("📤 Estrazione")],  # CAMBIATO: "Le mie squadre" → "Squadre"
...
async def export_miei_cambi(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        writer.writerow(['tipo', 'id_cambio', 'tipo_scambio', 'stato', 'data_creazione', 
                        'data_turno', 'tipo_turno', 'squadra', 'altro_utente'])
        
        # Cambi ceduti
        for cambio in cambi_ceduti:
            id_cambio, tipo_scambio, stato, data_creazione, data_turno, tipo_turno, squadra, nome_a, cognome_a = cambio
            writer.writerow([
                'CEDUTO',
                id_cambio,
                tipo_scambio,
        ...
        for cambio in cambi_ricevuti:
            id_cambio, tipo_scambio, stato, data_creazione, data_turno, tipo_turno, squadra, nome_da, cognome_da = cambio
            writer.writerow([
                'RICEVUTO',
                id_cambio,
                tipo_scambio,
...
# ... [le restanti funzioni rimangono uguali] ...
...
async def gestisci_messaggio_testo(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    elif testo == "👥 Squadre":  # CAMBIATO: "Le mie squadre" → "Squadre"
...
def main():
    ...
    print("✅ Sequenze turni corrette (S1n primo)")
