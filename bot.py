...
async def gestisci_richieste(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    messaggio += f"📞 Telefono: {telefono or 'Non fornito'}\n"
...
async def mostra_utenti_approvati(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = []
    for user_id_u, username, nome, cognome, telefono, ruolo, data_approvazione, sq_notte, sq_sera, sq_festiva in utenti_normali:
